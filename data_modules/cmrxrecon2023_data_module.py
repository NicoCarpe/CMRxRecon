...
def worker_init_fn(worker_id):
    ...
    data: Union[
        CmrxReconSliceDataset2023, CombinedCmrxReconSliceDataset2023
    ...
    if isinstance(data, CombinedCmrxReconSliceDataset2023):
...
class CmrxReconDataModule(pl.LightningDataModule):
    ...
    def __init__(
        ...
        # TODO: ugly but working code, mapping data will be loaded in CmrxReconSliceDataset2023
    ...
    def _create_data_loader(
        ...
        dataset: Union[CmrxReconSliceDataset2023, CombinedCmrxReconSliceDataset2023]
        if is_train and self.combine_train_val:
            ...
            dataset = CombinedCmrxReconSliceDataset2023(
                roots=data_paths,
            ...
            dataset = CmrxReconSliceDataset2023(
                root=data_path,
