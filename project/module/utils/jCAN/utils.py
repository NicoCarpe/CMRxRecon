...
def convert_mat_to_h5(mat_path, h5_path, protocal):
    # Convert .mat file with path mat_path to h5 file stored at h5_path
    # Protocol name as string

    # Load the .mat file
    mat_data = sio.loadmat(mat_path)
    array = mat_data['kspace_data'].astype(np.float32)
